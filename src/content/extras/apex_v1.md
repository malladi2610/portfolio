...
4. The project just started as a simple replacment for the assignement, went on to changes to address the irrigation problems and then evolved to the making the existing hydroponics systems automated and make it easy to use for farmers
5. This project was the first price that I won during my bachelors and recieved a funding of 1000 euros to.
6. This project taught me on make a prototype while solving a problem using the off the shelf components 
7. THis is the project that taught me on how to strucutre a problem statement, do a literature review and work with a team
8. Later on this project went on to evolve into a Crop recommendation. system that could be integrated with hydroponics system and the natural soil based farming
9. Overall it is a memerable project where I learn about building a solid prototype, interfacing with multiple sensors and utilising IoT and finally building something that works and solve a problems and have fun builiding it with my firends
