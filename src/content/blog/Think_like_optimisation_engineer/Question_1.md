...
![Worker-Observer baseline architecture showing the task contract, runtime, worker, observer, state machine, model and tool boundaries.](/images/blog/think_like_optimisation_engineer/question_1/woa_block_diagram_dark.png)
