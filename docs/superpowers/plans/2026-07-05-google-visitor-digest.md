...
- [x] **Step 1: Write failing generated-script tests**
...
- [x] **Step 3: Implement the minimal browser beacon**
...
- [x] **Step 4: Run the browser tests and verify GREEN**

Run: `node --test tests/view-ping.test.mjs`

Expected: all browser tracking tests pass.

- [x] **Step 5: Commit the browser contract**
...
- [x] **Step 1: Write failing Apps Script recording tests**
...
- [x] **Step 2: Run the Apps Script tests and verify RED**

Run: `node --test tests/apps-script-visitor-digest.test.mjs`

Expected: FAIL because `Code.gs` does not exist.

- [x] **Step 3: Implement validation, timestamping, deduplication, and locked writes**
...
- [x] **Step 4: Run the recording tests and verify GREEN**
...
- [x] **Step 1: Add failing digest tests**
...
- [x] **Step 3: Implement digest reliability and setup**
...
- [x] **Step 4: Run all Apps Script tests and verify GREEN**

Run: `node --test tests/apps-script-visitor-digest.test.mjs`

Expected: all tests pass, including retry-safe email failure behavior.

- [x] **Step 5: Commit the Apps Script implementation**
...
- [x] **Step 1: Document the complete manual workflow**
...
- [x] **Step 2: Remove all Cloudflare visitor-tracking repository files**
...
- [x] **Step 4: Verify no Cloudflare visitor-tracking references remain**

Run:

```bash
rg -n -i "VisitorTracking|visitorTrackingEndpoint|cloudflare" README.md src docs apps-script package.json --glob '!docs/superpowers/**'
```

Expected: no matches outside the historical design/plan documents, and `cloudflare/` no longer exists.

- [x] **Step 5: Commit documentation and cleanup**
...
- [x] **Step 2: Run the required production build**
...
- [x] **Step 5: Stop before external actions**
